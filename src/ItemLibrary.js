...
module.exports.AllItems = [
    ...
    new ItemData('Super-Brain Bubble Gum','Pop some gum and explore your newfound mental powers!','SuperBrainGum.png', ['Vending', 'Artifact', 'Psionic']),
    ...
    new ItemData('Telekinetic Beetle','This beetle can see inside locks and open them telekinetically.','TKBeetle.png', ['Mutant','Key']),
